...
export function buildPageSequence(
  ...
  // Two blanks — the first is the back-of-cover, the second pairs with the
  // title page so the second physical spread reads blank | title (clean
  // typographic frontispiece per Lukasz's feedback). Without both, title
  // would land on the same sheet as cover or as the next illustration,
  // breaking the illus | text rhythm of every later spread.
