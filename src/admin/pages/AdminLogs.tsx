                      ...
                      <td colSpan={5} className="px-4 py-4 bg-blue-50/50">
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4 text-sm">
                              ...
                              <span className="text-neutral-500">
                                {logDetail.durationMs
                                  ? `${(logDetail.durationMs / 1000).toFixed(2)}s`
                                  : '—'}
                              </span>
                            </div>
                            <button
                          ...
                          <div>
                            ...
                            <pre className="mt-1 rounded-lg bg-white px-3 py-2 text-xs text-neutral-600 overflow-x-auto whitespace-pre-wrap max-h-48 overflow-y-auto border border-neutral-100">
                          ...
                          <div>
                            ...
                            <pre className="mt-1 rounded-lg bg-white px-3 py-2 text-xs text-neutral-600 overflow-x-auto whitespace-pre-wrap max-h-32 overflow-y-auto border border-neutral-100">
                          ...
                          {logDetail.response && (
                            <div>
                              ...
                              <pre className="mt-1 rounded-lg bg-white px-3 py-2 text-xs text-neutral-600 overflow-x-auto whitespace-pre-wrap max-h-64 overflow-y-auto border border-neutral-100">
                                {logDetail.response}
                              </pre>
                            </div>
                          )}
