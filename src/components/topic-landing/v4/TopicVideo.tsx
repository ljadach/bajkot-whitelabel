...
import { GENERATION_MINUTES } from '../../../data/pricing';
import { PROMO_VIDEO } from './lpContent';

export function TopicVideo({ topic }: { topic: Topic }) {
  return (
    <section className="py-12 px-6 bg-cream" id="film">
      <div className="max-w-6xl mx-auto">
        ...
        <video
          ...
          className="w-full max-w-3xl h-auto aspect-video rounded-3xl shadow-2xl shadow-navy/20 bg-black"
        >
