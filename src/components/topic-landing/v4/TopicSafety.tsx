...
import { SAFETY_POINTS, SPREAD_IMAGE } from '../../../data/lpContent';
import { CtaButton } from './CtaButton';

export function TopicSafety({ topic }: { topic: Topic }) {
  return (
    <section className="py-12 px-6 bg-lp-cream-dark">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        <div>
          <h2 className="text-xl md:text-3xl font-black text-lp-navy mb-4">
          ...
          <ul className="grid gap-3">
            ...
            <li className="bg-white rounded-2xl px-4 py-3 shadow-sm text-sm">
              <b className="text-lp-navy">Dane dziecka służą tylko bajce.</b> To, co opowiesz o
              swoim dziecku, służy do napisania jego bajki. Nie sprzedajemy tych informacji, nie
              pokazujemy ich innym rodzicom i nie używamy do reklam. Szczegóły:{' '}
              <a href="/polityka-prywatnosci" className="text-lp-teal-text font-bold">
