    ...
    <section className="segment-hero hero-section w-full relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 w-full relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="hero-headline text-3xl sm:text-4xl lg:text-5xl mb-6 leading-[1.15]">
            {headline}
          </h1>
          <p className="text-neutral-600 text-lg sm:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
            {emphasizeText(subheadline, 'font-semibold text-neutral-700')}
          </p>
