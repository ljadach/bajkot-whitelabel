...
The Bajkot mark is a monogram/icon used as favicon and app icon. It serves as the primary brand identifier.
...
The text "Bajkot" in Inter Bold with standard tracking. Always rendered as live text, not as a graphic.

- **Orthography:** `Bajkot` — capital B, lowercase rest.
