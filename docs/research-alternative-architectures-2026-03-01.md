...
- Using RAG for *facts and examples* while generating *narrative and structure* from LLM
...
- AI adapts *interaction style*, not the content itself

**Lesson:** You don't always need to generate content. Adapting *how* existing content is presented and *how* the tutor interacts can be more effective and much cheaper.
