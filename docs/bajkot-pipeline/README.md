...
Zintegrowanie pipeline'u generowania spersonalizowanych materialow szkoleniowych z istniejaca platforma AITutoro. Pipeline przyjmuje zamowienie (profil ucznia, preferencje), przetwarza je przez lancuch agentow LLM (planowanie, pisanie rozdzialow, generowanie ilustracji, korekta), i produkuje gotowy dokument.
